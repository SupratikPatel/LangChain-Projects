...
# Set by libregrtest/PerplexityChatBot.py so we can skip tests that are not
# useful for PGO
PGO = False

# Set by libregrtest/PerplexityChatBot.py if we are running the extended (time consuming)
